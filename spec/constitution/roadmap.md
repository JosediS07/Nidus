...
4. **004 · Notificaciones por correo** — envío automático de confirmaciones por email con Thymeleaf y `@Async`, integrado con reservas (creación, modificación, cancelación).
